...
const VendorProfileScreen = ({ navigation }) => {
  ...
  const menuItems = [
    ...
    { icon: 'briefcase-outline', title: 'My Services', action: null },
    { icon: 'star-outline', title: 'Reviews & Ratings', action: null },
    { icon: 'wallet-outline', title: 'Earnings & Payments', action: null },
    ...
    <ScrollView style={styles.container}>
      <View style={styles.profileHeader}>
        <View style={styles.avatar}>
          <Text style={styles.avatarText}>{user?.firstName?.charAt(0) || 'V'}</Text>
        </View>
