  ...
  return (
    <View style={commonStyles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <Text style={styles.bodyText}>This is the Contact Us for NyumbaSync. For the full text, please visit nyumbasync.co.ke/legal or contact legal@nyumbasync.co.ke.</Text>
